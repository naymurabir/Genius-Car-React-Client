        ...
        <div>
            <div className="carousel w-full h-[200px] md:h-[400px] lg:h-[450px]">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/R4c30t0/2.jpg" className="w-full rounded" />

                    <div className="absolute h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/9gjSNCw/3.jpg" className="w-full rounded" />
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/b1yF333/1.jpg" className="w-full rounded" />
